                                    ...
                                    <tr>
                                        <td>
                                            <table border="0" cellpadding="0">
                                                <tr>
                                                    <td class="nls" align="center" colspan="2" style="font-weight: bold;" height="60">
                                                        Forgot Password
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right">
                                                        <asp:Label ID="UserNameLabel" runat="server" CssClass="nls" AssociatedControlID="UserName">Please Enter Username : </asp:Label>
                                                    </td>
                                                    <td>
