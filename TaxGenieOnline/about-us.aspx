<%@ Page Title="About Us" Language="C#" MasterPageFile="~/TaxGenie.Master" AutoEventWireup="true"
    CodeBehind="about-us.aspx.cs" Inherits="TaxGenieOnline.about_us" %>
    ...
    <div class="cl22 fleft">
        <div class="contentbox">
            ...
            <div class="contentboxmiddle">
                ...
                <div class="ab">
                 <p> &nbsp;&nbsp;&nbsp;Taxgenieonline.com is a portal run by M/s MARK PROFESSIONAL SERVICES PRIVATE LIMITED, a body corporate, registered under the Companies Act, 1956.  Taxgenieonline.com is a complete Tax Portal commenced its operations from 1st June, 2012.  We started this website because people deserve professional assistance as lakhs of them find difficulty in paying their taxes. We believe in helping the taxpayers to find clear solutions to their tax problems which allow them to run their business/industry without worries. </p>
