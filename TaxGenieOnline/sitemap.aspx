        ...
        <div class="contentbox">
            <div class="contentboxmiddle1">
                ...
                <div style="padding: 0 0 10px 0;">
                    ...
                    <div style="height: 15px; border-bottom: dashed 1px #999999;">
                    </div>
                    <div align="left" style="width: 720px; overflow: auto">
                        <div>
                            <div class="sitemap">
                            ...
                            <div class="sitemap">
                                <ul>
                                    <li style="padding-top: 15px;">
                                        <ul>
                                            <li><a href="http://www.cbec.gov.in/cs-manual-2012.pdf" target="_blank">Manual-2012</a></li>
                                            <li><a href="http://www.cbec.gov.in/deptt_offcr/cs-self-assesmt2011-manual.pdf" target="_blank">
                                                Manual on Self Assessment-2011</a> </li>
                        ...
                        <div>
                            ...
                            <div class="sitemap">
                                <ul>
                                    <li style="padding-top: 15px;">
                                        <ul>
                                            <li><a href="/index.aspx?cat=Service/Tax&subcat=Taxation/of/Services/An/Educational/Guide">
                                                Taxation of Services: An Educational Guide</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
